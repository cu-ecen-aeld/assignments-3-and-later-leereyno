...
struct thread_data{
	...
	// How long to wait before locking the mutex
	int wait_to_obtain_ms;

	// How long to wait before releasing the mutex
	int wait_to_release_ms;

	// A pointer to a mutex that our thread will be locking and unlocking
	pthread_mutex_t * mutex;

	// The thread ID of the thread launched
